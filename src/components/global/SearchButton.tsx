...
const SearchButton = () => {
    ...
    return ( 
        <div className="flex relative items-center justify-center">
            <Input type="text" placeholder="buscar..." value={inputSearch} onChange={(e: any) => SetInputSearch(e.target.value)} className="h-8 pl-2 pr-6 w-24 md:w-[150px] bg-zinc-600/80 border border-zinc-300"/>
